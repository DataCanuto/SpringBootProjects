package springbootai.budgeting.application;

import springbootai.budgeting.application.input.PersistTransactionInput;
import springbootai.budgeting.application.output.TransactionOutput;
